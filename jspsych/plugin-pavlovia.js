	...
	class PavloviaPlugin
	{
		...
		async _finish(trial, data)
		{
			try
			{
				...
				const msg = "<b>Merci de patienter un moment le temps que nous sauvegardions vos données...</b>";
				const displayElement = this._jsPsych.getDisplayElement();
				displayElement.innerHTML = `
				<p id="pavlovia-data-upload" style="font-size: 20px; text-align: center;">
					${msg}
				</p>
				`;
