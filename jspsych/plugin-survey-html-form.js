  ...
  class SurveyHtmlFormPlugin {
    ...
    trial(display_element, trial) {
      ...
      if (trial.preamble !== null) {
		//preamble takes the full page width
		//html += '<div id="jspsych-survey-html-form-preamble" class="jspsych-survey-html-form-preamble">' + trial.preamble + "</div>";
		//preamble takes only 600px of width
        html += '<div id="jspsych-survey-html-form-preamble" class="jspsych-survey-html-form-preamble" style="max-width:600px; margin: 0 auto;">' + trial.preamble + "</div>";
      }
