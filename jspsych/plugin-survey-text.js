  ...
  class SurveyTextPlugin {
    ...
    trial(display_element, trial) {
      ...
      for (var i = 0; i < trial.questions.length; i++) {
		...
		//question prompt takes the full page of width
        //html += '<p class="jspsych-survey-text">' + question.prompt + "</p>";
		//question prompt takes 600px of width
		html += '<p class="jspsych-survey-text" style="max-width:600px; margin:0 auto;">' + question.prompt + '</p>';
