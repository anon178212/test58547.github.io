  ...
  class InstructionsPlugin {
    ...
    trial(display_element, trial) {
      ...
      function show_current_page() {
		//instructions take the full width of the page
        //var html = trial.pages[current_page];
		//instructions are centered and take only 800px of width
		var html = "<div style='max-width:800px;margin:0 auto;padding:20px;line-height:1.6;text-align:left;'>" + trial.pages[current_page] + "</div>";
        var pagenum_display = "";
